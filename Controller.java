...
public class Controller {
					...
					case 1:
						while (!end) {
							...
							if (ok == true) {
								...
								System.out.println("Der Knoten existiert bereits. Bitte w�hlen Sie einen anderen Namen!");
						}
						break;
					case 2:
						String r = "", t = "";
						while (!end) {
							...
							if (equal == true || ok == false){
								System.out.println("W�hlen Sie einen anderen Zielknoten aus!");
								r = null;
								t = null;
							}
						...
						break;
					case 3:
						System.out.println("Welchen Knoten wollen Sie l�schen?");
						g.knotenausgabe();
						int wahl = in.nextInt() - 1;
						g.deleteNode(wahl);
						break;
					case 4:
						System.out.println("Welche Kante wollen Sie l�schen?");
						g.print();
	...
	public void printMainInfo() {
		...
		System.out.println("(2) Zuf�lliger Graph");
		System.out.println("(0) Ende des Programms");
	}
	
	public void printInfo1() {
		System.out.println("Was m�chten Sie tun?\n\n");
		System.out.println("(1) Knoten hinzuf�gen");
		System.out.println("(2) Kante hinzuf�gen");
		System.out.println("(3) Knoten l�schen");
		System.out.println("(4) Kante l�schen");
		...
		System.out.println("(9) Zur�ck ins Hauptmen�");
		System.out.println("(0) Ende des Programms");
		//System.out.println("");
	}
	...
	public void printInfo2() {
		...
		System.out.println("(4) Zur�ck ins Hauptmen�");
		System.out.println("(0) Ende des Programms");
	}
